...
```{r ans23}
names(commitCheck)[1:30] <- c(str_c("commit",c(1:30)))
commitCheck
```
...
commithourminute <- hour(allCommitDatesTW)+(minute(allCommitDatesTW)/100)
logicWithinTimeFrame <- (commithourminute>=4.30) & (commithourminute<=6.30)
